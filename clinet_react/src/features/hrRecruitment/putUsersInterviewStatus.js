...
export const PutUsersInterviewStatus = async (personnelIds, interviewResult) => {
    try {
        ...
        if (response.status === 200 || response.status === 204 || response.status === 201) { // Thêm 201 vào điều kiện
            return {
                success: true,
