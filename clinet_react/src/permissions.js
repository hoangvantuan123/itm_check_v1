...
export const checkMenuPermission = (permissions, menuKey, action = 'view', submenuKey = null) => {
    if (!permissions.menu[menuKey]) return false;
  
    if (submenuKey) {
      if (permissions.menu[menuKey].submenus && permissions.menu[menuKey].submenus[submenuKey]) {
  ...
  export const checkActionPermission = (permissions, menuKey, actionKey, submenuKey = null) => {
