...
export default function ShowMoreChart({ idChart, setShowMoreTemplate }) {
  const dispatch = useDispatch()
  const { id } = useParams()

  const handleOnClickDeleteNodesChart = () => {
    dispatch(deleteNodesAsync(idChart))
    ...
    <div className=" border shadow rounded-md bg-white right-[-150px] w-60 h-auto absolute z-50">
      ...
      <div className=" h-auto p-1">
        <ul className="space-y-1">
          ...
          <li>
            <a
              onClick={handleOnClickDeleteNodesChart}
