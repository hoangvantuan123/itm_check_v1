...
import EditSlackGroup from '../workflows/view-edit/slack-group'
import ShowMoreSlackGroup from './show-more-slack-group'
...
function TemplateSlackGroup({ id, data, isConnectable }) {
  const dispatch = useDispatch()

  const [showTemplateSlack, setShowTemplateSlack] = useState(false)
  ...
  const OnClickShowViewTrigger = () => {
    setShowTemplateSlack(!showTemplateSlack)
  }
      ...
      {showTemplateSlack ? (
        ...
        <>
          <div className="p-2">
            ...
            {/* 
<div className="mt-3">   {alignValue == 'Channel' && (
                  <>
                  
                  <Form  >
          <Form.Item label="Slack URL" >
          ...
          <Input className=" border" />
           ...
           <Input className=" border" />
            ...
            <EditSlackGroup data={data} nodeId={id} alignValue={alignValue} />
          </div>
        </>
      )}
      <Handle
...
export default TemplateSlackGroup
