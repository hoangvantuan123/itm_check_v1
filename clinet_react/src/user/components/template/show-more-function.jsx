...
export default function ShowMoreFunction({ idFunction, setShowMoreTemplate }) {
  const dispatch = useDispatch()
  const { id } = useParams()

  const handleOnClickDeleteNodes = () => {
    dispatch(deleteNodesAsync(idFunction))
  ...
  return (
    <div className=" border shadow rounded-md bg-white right-[-150px] w-60 h-auto absolute z-50">
      ...
      <div className=" h-auto border-b p-1 ">
        {' '}
        <button className=" w-full flex items-center gap-2 rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
