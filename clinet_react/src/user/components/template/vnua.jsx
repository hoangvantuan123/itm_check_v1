...
import EditVnua from '../workflows/view-edit/vnua'
import ShowMoreVnua from './show-more-vnua'
...
function TemplateVnua({ id, data, isConnectable }) {
    ...
    <div className=" h-auto  w-96 border rounded-lg p-1  bg-white">
      ...
      <div className="flex items-center justify-between p-1">
        <div className="flex items-center gap-1  ">
          <Image src={VnuaLogo} style={{ width: '25px', height: '20px' }} />
      ...
      {showMoreTemplate && (
        <ShowMoreVnua idEmails={id} setShowMoreTemplate={setShowMoreTemplate} />
      )}
