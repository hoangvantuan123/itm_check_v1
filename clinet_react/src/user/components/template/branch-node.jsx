...
import EditBranch from '../workflows/view-edit/branch'
import ShowMoreBranch from './show-more-branch'
const { Option } = Select
...
function TemplateBranch({ id, data, isConnectable }) {
        ...
        <>
          <div className="p-2">
            ...
            <div className=" border w-full rounded-lg bg-slate-50 p-1">
              ...
              <EditBranch data={data} code={code} />
            </div>
          </div>
        </>
      )}
