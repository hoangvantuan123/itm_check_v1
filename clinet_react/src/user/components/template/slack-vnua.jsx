...
import EditSlackVnua from '../workflows/view-edit/vnua-slack'
import ShowMoreSlackVnua from './show-more-slack-vnua'
...
function TemplateSlackVnua({ id, data, isConnectable }) {
      ...
      {showTemplateSlack ? (
        ...
        <>
          <div className="p-2">
            ...
            <EditSlackVnua data={data} nodeId={id} alignValue={alignValue} nodenew={nodenew} />
          </div>
        </>
      )}
      <Handle
...
export default TemplateSlackVnua
