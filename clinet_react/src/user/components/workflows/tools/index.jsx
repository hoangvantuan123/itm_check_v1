...
export default function Tools({
  openAddNode,
  openShowWorkFlow,
  openShowListWorkFlow,
  openShowFunctionsWorkFlow,
  openShowTriggersWorkFlow,
}) {
  return (
    <div className="w-12  bg-white border-r p-1 flex flex-col items-center gap-1">
      <a
        onClick={openShowWorkFlow}
        className="flex items-center  justify-center gap-2 rounded-lg p-2 cursor-pointer text-gray-500 hover:bg-gray-100 hover:text-gray-700"
      >
        <SearchIcon />
      </a>
      <a
      ...
      <a
        onClick={openShowFunctionsWorkFlow}
        className="flex items-center  justify-center gap-2 rounded-lg p-2 cursor-pointer text-gray-500 hover:bg-gray-100 hover:text-gray-700"
      >
        <FunctionIcon />
      </a>
      <a
        onClick={openShowTriggersWorkFlow}
        className="flex items-center  justify-center gap-2 rounded-lg p-2 cursor-pointer text-gray-500 hover:bg-gray-100 hover:text-gray-700"
      >
        <TriggerIcon />
      </a>
