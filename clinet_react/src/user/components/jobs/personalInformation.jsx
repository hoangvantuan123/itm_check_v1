...
const PersonalInformation = ({form}) => {
  ...
  return (
    <div>
      ...
      <Row gutter={16}>
        ...
        <Col xs={12} sm={12} md={12}>
          <Form.Item 
            ...
            name="interviewDate" 
            rules={[{ required: true, message: 'Vui lòng nhập ngày phỏng vấn!' }]}
          >
            <DatePicker size='large' style={{ width: '100%' }} placeholder="Chọn ngày phỏng vấn" />
          </Form.Item>
        </Col>
        <Col xs={12} sm={12} md={12}>
          <Form.Item label="Ngày vào:" name="startDate">
            <DatePicker size='large' style={{ width: '100%' }} placeholder="Chọn ngày vào" />
          </Form.Item>
        </Col>
        ...
        <Col xs={24} sm={12} md={8}>
          ...
          >
            <InputNumber size='large' style={{ width: '100%' }} placeholder="Nhập số CMND" />
          </Form.Item>
        </Col>
      ...
      <h3 className="font-semibold mb-2">Địa chỉ đăng ký giấy khai sinh (hoặc nguyên quán hoặc HKTT hoặc tạm trú)</h3>
      <Row gutter={16}>
        <Col xs={24} sm={12} md={8}>
          <Form.Item 
            label="Tỉnh:" 
