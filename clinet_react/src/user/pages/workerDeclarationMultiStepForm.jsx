...
const formatSubmissionData = (finalData) => {
    const result = {
        ...
        experiences: finalData?.workExperiences?.map(experience => filterEmptyFields({
  ...
  return (
    ...
    <p className="text-base text-gray-500 mt-4">
        Cảm ơn bạn đã cung cấp thông tin. Chúng tôi cam kết bảo mật dữ liệu theo quy định.
    </p>
    <p className="text-xs text-gray-400 mt-2 italic">
        Lưu ý: Nếu phát hiện thông tin không chính xác, đơn của bạn có thể bị từ chối mà không cần thông báo trước.
    </p>
</div>
