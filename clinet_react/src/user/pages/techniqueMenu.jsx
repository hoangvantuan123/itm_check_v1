    ...
    return (
        <div className="w-full h-screen bg-slate-50">
            ...
            <div className="p-2 flex items-center justify-between">
                ...
                <AddMenu isOpen={isModalOpenMenu}
                    onClose={closeModalAddMenu} fetchTableData={fetchData} />
            </div>
            <div> {!isMobile && (
            ...
            <MenuDrawer selectedDetails={selectedDetails} isModalVisible={isModalVisible} handleCancel={handleCancel} fetchTableData={fetchData} />
        </div>
    );
}
