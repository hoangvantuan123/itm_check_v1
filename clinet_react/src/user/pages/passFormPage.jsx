...
const PassFormPage = () => {
    ...
    const handleSubmit = (values) => {
        ...
        setTimeout(() => {
            setLoading(false);
            navigate('/u/apply/candidate-application/view=form');
        }, 2000);
    };
        ...
        <div className="flex flex-col h-screen bg-white p-6">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center justify-between border p-2 rounded-lg bg-slate-600 ">
                    {/* <img src={Logo} alt="Logo" className="mr-2" style={{ maxHeight: '40px' }} /> */} {/* Adjust logo size */}
                </div>
            ...
            <div className="flex-grow flex flex-col items-center justify-center">
                <Title level={2} className="text-center">{t("Chào mừng bạn đến với mẫu tờ khai online!")}</Title>
                    ...
                    >
                        <Form.Item
                            ...
                            rules={[
                                ...
                                { pattern: /^\d+$/, message: t('Số điện thoại chỉ bao gồm các chữ số!') }
                            ]}
