...
const MultiStepFormPage = () => {
  ...
  // Hàm validate các trường dữ liệu trong form của từng bước
  ...
  // Hàm để lưu dữ liệu của bước hiện tại vào state formData
  const saveCurrentStepData = () => {
    ...
    switch (currentStep) {
      ...
      case 3:
        ...
        break;
      case 4:
        updatedData.applicationData = { ...updatedData.applicationData, ...currentValues };
        break;
      default:
        break;
    }
  ...
  const formatSubmissionData = (finalData) => {
    const result = {
      ...
      officeSkills: [
        ...finalData?.officeSkillsData?.officeSkills?.map((skill) => filterEmptyFields({
          skill_name: skill?.skill || null,
          skill_level: skill?.level || null,
        })) || [],
        ...finalData?.officeSkillsData?.softwareSkills?.map((softwareSkill) => filterEmptyFields({
  ...
  /* const handleSubmit = async () => {
    ...
    if (isValid) {
      ...
      console.log('Dữ liệu cuối cùng gửi đi:', submissionData);
  ...
  const steps = [
    ...
    },
    {
      ...
      content: (
        <Suspense fallback={<Spin />}>
          <FamilyInfoTable form={form} isMobile={isMobile} setFamilyMembers={setFamilyMembers} familyMembers={familyMembers} />
        </Suspense>
      ),
    },
    {
      ...
      content: (
        <Suspense fallback={<Spin />}>
          <EducationLanguageTable form={form} isMobile={isMobile} setEducationData={setEducationData} educationData={educationData} languageData={languageData} setLanguageData={setLanguageData} />
          <OfficeSkillsTable form={form} isMobile={isMobile} formData={formData} />
          <WorkExperienceTable form={form} isMobile={isMobile} initialWorkExperience={initialWorkExperience} initialProject={initialProject} projects={projects} setProjects={setProjects} workExperiences={workExperiences} setWorkExperiences={setWorkExperiences} />
        </Suspense>
      ),
    },
    {
